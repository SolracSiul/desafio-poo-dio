...
public class Banco {
	...
	static String nome = "Solrac Bank";
	...
	public static void efetuarSaque() {
		...
		Conta conta = Banco.buscarContaPorNumero(numero); // falta criar esse método
		...
		if(conta != null) {
			...
			System.out.println("Conta não foi encontrada a conta número " + numero);
		}
		Utils.pausar(5);
		Banco.menu();
	}
	public static void efetuarDeposito() {
		...
		Conta conta = Banco.buscarContaPorNumero(numero); //falta criar esse método também
		if(conta != null) {
	...
	public static void efetuarTransferencia() {
		...
		if(conta_o != null) {
			System.out.println("Informe o númeo da conta destino: ");
			...
			conta_o.transferir(conta_d, valor);
				...
				System.out.println("A conta destino numero " + numero_d + "não foi encontrada.");
			}
		}else {
